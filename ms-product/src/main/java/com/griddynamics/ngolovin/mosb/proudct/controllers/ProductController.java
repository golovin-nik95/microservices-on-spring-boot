package com.griddynamics.ngolovin.mosb.proudct.controllers;

import com.griddynamics.ngolovin.mosb.proudct.exceptions.ProductNotFoundException;
import com.griddynamics.ngolovin.mosb.proudct.models.Product;
import com.griddynamics.ngolovin.mosb.proudct.services.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> productByUniqId(@PathVariable String uniqId) {
        log.info("GET productByUniqId uniqId={}", uniqId);
